...
export const garmentInfo = {
  ...
  descriptionEn: 'Identified as a summer sleeveless knit vest with round neckline, sleeveless design, and relaxed fit. Includes front, back, and three binding strips (neckline, armhole, hem), 5 pattern pieces total.',
  images: [], // 用户上传的多张图片
}
